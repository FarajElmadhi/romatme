...
class BrandsDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.brands.buttons.actions')
    ...
    {
        return Brand::query()->select("brands.*");
...
[
				...
				[
                 'name'=>'brand_name',
                 'data'=>'brand_name',
                 'title'=>trans('admin.brand_name'),
		    ],
				[
                 'name'=>'brand_title',
                 'data'=>'brand_title',
                 'title'=>trans('admin.brand_title'),
		    ],
				[
                 'name'=>'brand_description',
                 'data'=>'brand_description',
                 'title'=>trans('admin.brand_description'),
		    ],
            [
	                'name' => 'created_at',
	                'data' => 'created_at',
