...
class CatergoryDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.catergory.buttons.actions')
    ...
    {
        return Category::query()->with(['brand_id',])->select("categories.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,4,5,6,7', 'input') . "

                        //brand_idcategory_name,brand_id,title,description,slug,tags3
            ". filterElement('3', 'select', \App\Models\Brand::pluck("brand_name","brand_name")) . "
