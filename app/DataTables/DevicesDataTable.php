...
class DevicesDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.devices.buttons.actions')
    ...
    {
        return Device::query()->select("devices.*");
    	...
    	public function html()
	    {
	      $html =  $this->builder()
            ...
            ". filterElement('1,2,3,4,5,6,7,8,9', 'input') . "
...
[
				...
				[
                 'name'=>'model',
                 'data'=>'model',
                 'title'=>trans('admin.model'),
		    ],
				[
                 'name'=>'model_name',
                 'data'=>'model_name',
                 'title'=>trans('admin.model_name'),
		    ],
				[
                 'name'=>'brand_id',
                 'data'=>'brand_id',
