...
class VersionDataTable extends DataTable
{
    ...
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'admin.version.buttons.actions')
    ...
    {
        return Version::query()->select("versions.*");
...
[
				...
				[
                 'name'=>'version',
                 'data'=>'version',
                 'title'=>trans('admin.version'),
		    ],
				[
                 'name'=>'version_name',
                 'data'=>'version_name',
                 'title'=>trans('admin.version_name'),
		    ],
				[
                 'name'=>'slug',
                 'data'=>'slug',
