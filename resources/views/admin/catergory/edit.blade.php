	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				...
				<a href="{{aurl('catergory/'.$catergory->id)}}" class="dropdown-item" style="color:#343a40">
...
{!! Form::open(['url'=>aurl('/catergory/'.$catergory->id),'method'=>'put','id'=>'catergory','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">

<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        {!! Form::label('category_name',trans('admin.category_name'),['class'=>'control-label']) !!}
        {!! Form::text('category_name', $catergory->category_name ,['class'=>'form-control','placeholder'=>trans('admin.category_name')]) !!}
    </div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
		<div class="form-group">
				{!! Form::label('brand_id',trans('admin.brand_id'),['class'=>'control-label']) !!}
{!! Form::select('brand_id',App\Models\Brand::pluck('brand_name','id'), $catergory->brand_id ,['class'=>'form-control select2','placeholder'=>trans('admin.brand_id')]) !!}
		</div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        {!! Form::label('title',trans('admin.title'),['class'=>'control-label']) !!}
        {!! Form::text('title', $catergory->title ,['class'=>'form-control','placeholder'=>trans('admin.title')]) !!}
    </div>
</div>
<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
    <div class="form-group">
        {!! Form::label('description',trans('admin.description'),['class'=>'control-label']) !!}
        {!! Form::textarea('description', $catergory->description ,['class'=>'form-control ckeditor','placeholder'=>trans('admin.description')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('slug',trans('admin.slug'),['class'=>'control-label']) !!}
        {!! Form::text('slug', $catergory->slug ,['class'=>'form-control','placeholder'=>trans('admin.slug')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('tags',trans('admin.tags'),['class'=>'control-label']) !!}
        {!! Form::textarea('tags', $catergory->tags ,['class'=>'form-control','placeholder'=>trans('admin.tags')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    ...
    "id"=>$catergory->id,
    "route"=>"catergory",
    "path"=>"catergory/".$catergory->id,
    ])
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('views',trans('admin.views'),['class'=>'control-label']) !!}
        {!! Form::text('views', $catergory->views ,['class'=>'form-control','placeholder'=>trans('admin.views')]) !!}
    </div>
</div>
