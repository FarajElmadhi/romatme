	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('devices') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/devices'),'id'=>'devices','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('brand_id',trans('admin.brand_id'),['class'=>' control-label']) !!}
            {!! Form::text('brand_id',old('brand_id'),['class'=>'form-control','placeholder'=>trans('admin.brand_id')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('thumbnail',trans('admin.thumbnail'),['class'=>' control-label']) !!}
            {!! Form::text('thumbnail',old('thumbnail'),['class'=>'form-control','placeholder'=>trans('admin.thumbnail')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('photo',trans('admin.photo'),['class'=>' control-label']) !!}
            {!! Form::text('photo',old('photo'),['class'=>'form-control','placeholder'=>trans('admin.photo')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('info',trans('admin.info'),['class'=>' control-label']) !!}
            {!! Form::text('info',old('info'),['class'=>'form-control','placeholder'=>trans('admin.info')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
