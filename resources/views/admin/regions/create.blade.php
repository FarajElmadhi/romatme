	...
	<div class="card-header">
		...
		<div class="">
			...
			<div class="dropdown-menu" role="menu">
				<a href="{{ aurl('regions') }}"  style="color:#343a40"  class="dropdown-item">
...
{!! Form::open(['url'=>aurl('/regions'),'id'=>'regions','files'=>true,'class'=>'form-horizontal form-row-seperated']) !!}
<div class="row">
...
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('country',trans('admin.country'),['class'=>' control-label']) !!}
            {!! Form::text('country',old('country'),['class'=>'form-control','placeholder'=>trans('admin.country')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
        {!! Form::label('flag',trans('admin.flag'),['class'=>' control-label']) !!}
            {!! Form::text('flag',old('flag'),['class'=>'form-control','placeholder'=>trans('admin.flag')]) !!}
    </div>
</div>
<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
    <div class="form-group">
